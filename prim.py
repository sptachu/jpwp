...
if __name__ == '__main__':
    ...
    print("\nCałkowity koszt MST (Prim Lista krawędzi): ", cost_edge_list_mst_prim)
    edge_list_mst_kruskal = kruskal_mst_edge_list(G_edge_list)
    cost_edge_list_mst_kruskal = cost_edge_list(edge_list_mst_kruskal)
    print("Całkowity koszt MST (Kruskal Lista krawędzi): ", cost_edge_list_mst_kruskal)
    ...
    print("Najkrótsze ścieżki z wierzchołka (Lista krawędzi) ", start_node)
    for line in paths:
        print(line)
